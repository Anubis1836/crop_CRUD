...
class AddEquipmentComponent extends Component {
    ...
    saveOrUpdateEqs = (e) => {
        ...
        if(this.state.eqName.trim() !='' && this.state.eqPrice.trim() != '' && this.state.eqDetails.trim()!='')
        {
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <div className = "form-group">
                                            <label> Price: </label>
                                            <input placeholder="Equipment Price" name="eqPrice" className="form-control" 
                                                value={this.state.eqPrice} onChange={this.changeEqPriceHandler}/>
                                        </div>
                                        <div className = "form-group">
                                            <label> Details: </label>
                                            <input placeholder="Equipment Details" name="eqDetails" className="form-control" 
