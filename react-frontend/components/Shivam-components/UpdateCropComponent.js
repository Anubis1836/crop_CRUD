...
class UpdateCropComponent extends Component {
    ...
    componentDidMount(){
        FMService.getCropById(this.state.id).then( (res) =>{
            let Crop = res.data;
            this.setState({firstName: Crop.firstName,
                lastName: Crop.lastName,
                emailId : Crop.emailId
            });
        });
    }
    ...
    updateCrop = (e) => {
        e.preventDefault();
        let Crop = {firstName: this.state.firstName, lastName: this.state.lastName, emailId: this.state.emailId};
                                ...
                                <div className = "card-body">
                                    <form>
                                        <div className = "form-group">
                                            ...
                                            <input placeholder="Cr" name="firstName" className="form-control" 
